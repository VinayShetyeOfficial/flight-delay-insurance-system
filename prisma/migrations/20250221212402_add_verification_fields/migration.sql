...
-- CreateIndex
CREATE UNIQUE INDEX "Claim_insuranceId_key" ON "Claim"("insuranceId");
...
-- AddForeignKey
ALTER TABLE "Claim" ADD CONSTRAINT "Claim_insuranceId_fkey" FOREIGN KEY ("insuranceId") REFERENCES "Insurance"("id") ON DELETE CASCADE ON UPDATE CASCADE;
