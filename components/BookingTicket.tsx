...
export function BookingTicket({ booking }: BookingTicketProps) {
  ...
  const addOnsTotalValue = Object.values(addOnsData).reduce((acc, val) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-[1024px] mx-auto">
        <Card className="overflow-hidden bg-white dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800/80">
          {/* Header Section with Gradient */}
          <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-purple-600 p-8 relative overflow-hidden">
            {/* Simple Pattern */}
            ...
            <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              ...
              <div
                className={cn(
                  "absolute top-0 right-0 px-3.5 py-1.5 rounded-full text-sm font-medium",
          ...
          <div className="p-8 space-y-8">
            ...
            {/* Back to Dashboard Button - With Hover */}
