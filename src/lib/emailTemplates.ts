      ...
      <body>
        ...
        <div class="content">
          ...
          <div class="price-breakdown">
            ...
            <p class="total">Total: $${booking.price + booking.insurance.price}</p>
          </div>
      ...
      <body>
        ...
        <div class="content">
          <div class="claim-details">
            ...
            <p><strong>Delay Duration:</strong> ${claim.delayDuration} minutes</p>
            <p><strong>Status:</strong> <span class="status ${claim.status.toLowerCase()}">${claim.status}</span></p>
          </div>
          ...
          <a href="${process.env.NEXTAUTH_URL}/dashboard" class="button">View Claim Details</a>
        </div>
